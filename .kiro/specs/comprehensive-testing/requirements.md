...
11. 当未登录用户查看资源卡片时，平台应显示该资源的下载积分信息
12. 当未登录用户查看资源详情页时，平台应显示下载所需积分和VIP等级要求
13. 当未登录用户点击下载按钮时，平台应提示登录并跳转到登录页面
14. 当用户成功下载付费资源后，平台应同步更新数据库中的积分余额
15. 当用户成功下载付费资源后，平台应在积分记录表中新增一条消费记录
16. 当已登录用户查看顶部导航栏时，平台应显示用户当前积分余额
17. 当已登录用户查看个人中心时，平台应在用户信息卡片中显示积分余额
18. 当已登录用户点击导航栏积分余额时，平台应跳转到积分详情页面
19. 当用户积分发生变动时（下载、充值、上传奖励），平台应实时更新所有显示积分的位置
...
10. 平台应防止积分余额变为负数
11. 当新用户注册时，平台应为普通用户分配初始积分500
12. 当用户成为VIP时，平台应根据VIP等级分配相应的额外积分
13. 当创作者上传资源并审核通过后，平台应奖励相应积分
14. 当用户积分发生变动时，平台应同步更新数据库记录
15. 当用户在任何页面查看积分时，平台应显示与数据库一致的实时余额
16. 当已登录用户查看顶部导航栏时，平台应显示用户当前积分余额
17. 当已登录用户查看个人中心时，平台应在用户信息卡片中显示积分余额
18. 当已登录用户点击导航栏积分余额时，平台应跳转到积分详情页面
19. 当用户积分发生变动时（下载、充值、上传奖励），平台应实时更新所有显示积分的位置
20. 当用户查看资源卡片时（无论是否登录），平台应显示该资源的下载积分信息
